...
type DriverServiceClient interface {
	RegisterDriver(ctx context.Context, in *RegisterDriveRequest, opts ...grpc.CallOption) (*RegisterDriverResponse, error)
	UnRegisterDriver(ctx context.Context, in *RegisterDriveRequest, opts ...grpc.CallOption) (*RegisterDriverResponse, error)
}
...
func (c *driverServiceClient) RegisterDriver(ctx context.Context, in *RegisterDriveRequest, opts ...grpc.CallOption) (*RegisterDriverResponse, error) {
...
func (c *driverServiceClient) UnRegisterDriver(ctx context.Context, in *RegisterDriveRequest, opts ...grpc.CallOption) (*RegisterDriverResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterDriverResponse)
...
type DriverServiceServer interface {
	RegisterDriver(context.Context, *RegisterDriveRequest) (*RegisterDriverResponse, error)
	UnRegisterDriver(context.Context, *RegisterDriveRequest) (*RegisterDriverResponse, error)
...
func (UnimplementedDriverServiceServer) RegisterDriver(context.Context, *RegisterDriveRequest) (*RegisterDriverResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterDriver not implemented")
}
func (UnimplementedDriverServiceServer) UnRegisterDriver(context.Context, *RegisterDriveRequest) (*RegisterDriverResponse, error) {
...
func _DriverService_RegisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).RegisterDriver(ctx, req.(*RegisterDriveRequest))
	}
...
func _DriverService_UnRegisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).UnRegisterDriver(ctx, req.(*RegisterDriveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
