...
func (x *RegisterDriveRequest) Reset() {
	*x = RegisterDriveRequest{}
	mi := &file_driver_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RegisterDriveRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterDriveRequest) ProtoMessage() {}

func (x *RegisterDriveRequest) ProtoReflect() protoreflect.Message {
	mi := &file_driver_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use RegisterDriveRequest.ProtoReflect.Descriptor instead.
func (*RegisterDriveRequest) Descriptor() ([]byte, []int) {
	return file_driver_proto_rawDescGZIP(), []int{0}
}

func (x *RegisterDriveRequest) GetDriverID() string {
	if x != nil {
		return x.DriverID
	}
	return ""
...
func (x *RegisterDriveRequest) GetPackageSlug() string {
	if x != nil {
...
const file_driver_proto_rawDesc = "" +
	"\n" +
	"\fdriver.proto\x12\x04trip\"T\n" +
	"\x14RegisterDriveRequest\x12\x1a\n" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude2\xa9\x01\n" +
	"\rDriverService\x12J\n" +
	"\x0eRegisterDriver\x12\x1a.trip.RegisterDriveRequest\x1a\x1c.trip.RegisterDriverResponse\x12L\n" +
	"\x10UnRegisterDriver\x12\x1a.trip.RegisterDriveRequest\x1a\x1c.trip.RegisterDriverResponseB\x1cZ\x1ashared/proto/driver;driverb\x06proto3"
...
var file_driver_proto_goTypes = []any{
	(*RegisterDriveRequest)(nil),   // 0: trip.RegisterDriveRequest
...
var file_driver_proto_depIdxs = []int32{
	...
	0, // 2: trip.DriverService.RegisterDriver:input_type -> trip.RegisterDriveRequest
	0, // 3: trip.DriverService.UnRegisterDriver:input_type -> trip.RegisterDriveRequest
