...
func (h *grpcHandler) RegisterDriver(ctx context.Context, req *pb.RegisterDriveRequest) (*pb.RegisterDriverResponse, error) {
...
func (h *grpcHandler) UnRegisterDriver(ctx context.Context, req *pb.RegisterDriveRequest) (*pb.RegisterDriverResponse, error) {
